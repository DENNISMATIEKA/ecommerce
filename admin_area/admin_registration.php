...
<body>
    <div class="container-fluid my-3 ">
        ...
        <div class="row d-flrx align-items-center justify-content-center ">
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-outline mb-4 ">
                        <label for="conf_admin_password" class="form-lable" >Confirm password</label>
                    ...
                    <div class="mt-4 pt-2" >
                        <input type="submit" value="Register" class="bg-info py2 px3 border-0" name="admin_register" >
